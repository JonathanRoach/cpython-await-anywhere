...
static PyMethodDef sys_methods[] = {
    ...
    {"breakpointhook", _PyCFunction_CAST(sys_breakpointhook),
     METH_FASTCALL | METH_KEYWORDS|METH_C_STACK_FRUGAL, breakpointhook_doc},
...
#ifdef Py_TRACE_REFS
    {"getobjects", _Py_GetObjects, METH_VARARGS|METH_C_STACK_FRUGAL},
#endif
    SYS_GETTOTALREFCOUNT_METHODDEF
    SYS_GETREFCOUNT_METHODDEF
    SYS_GETRECURSIONLIMIT_METHODDEF
    {"getsizeof", _PyCFunction_CAST(sys_getsizeof),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, getsizeof_doc},
    ...
    {"set_asyncgen_hooks", _PyCFunction_CAST(sys_set_asyncgen_hooks),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, set_asyncgen_hooks_doc},
