...
static PyNumberMethods proxy_as_number = {
    ...
    .nb_functionflags[_PyFunctionIndex_nb_lshift] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_rshift] = Py_FNFLAGS_FRUGAL,
    ...
    .nb_functionflags[_PyFunctionIndex_nb_inplace_add] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_subtract] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_multiply] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_remainder] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_power] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_lshift] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_rshift] = Py_FNFLAGS_FRUGAL,
    ...
    .nb_functionflags[_PyFunctionIndex_nb_inplace_floor_divide] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_inplace_true_divide] = Py_FNFLAGS_FRUGAL,
    .nb_functionflags[_PyFunctionIndex_nb_index] = Py_FNFLAGS_FRUGAL,
