...
{
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallNoArgs, func, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    return result;
...
PyObject_Call(PyObject *callable, PyObject *args, PyObject *kwargs)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_Call, &params, (void **)&result)){
        return NULL;
    }
    return result;
}
...
PyObject_CallOneArg(PyObject *func, PyObject *arg)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallOneArg, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    return result;
...
PyObject_CallObject(PyObject *callable, PyObject *args)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallObject, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    return result;
...
PyObject_CallFunction(PyObject *callable, const char *format, ...)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallFunction, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    va_end(params.va);
...
PyObject_CallMethod(PyObject *obj, const char *name, const char *format, ...)
{
    ...
    va_start(params.va, format);
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallMethod, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    va_end(params.va);
...
void *
co_PyObject_VectorcallMethod(void *_params)
{
    struct PyObject_VectorcallMethod_params *params = (struct PyObject_VectorcallMethod_params *)_params;
    PyObject *name = params->name;
    PyObject *const *args = params->args;
                           ...
                           size_t nargsf, PyObject *kwnames)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_VectorcallMethod, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    return result;
...
PyObject_CallMethodObjArgs(PyObject *obj, PyObject *name, ...)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallMethodObjArgs, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    va_end(params.va);
...
PyObject_CallFunctionObjArgs(PyObject *callable, ...)
{
    ...
    PyObject *result;
    if (_PyThreadStack_CallInsideCoroutine(co_PyObject_CallFunctionObjArgs, &params, (void **)&result)){
        PyErr_NoMemory();
        return NULL;
    }
    va_end(params.va);
