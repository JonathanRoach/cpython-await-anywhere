...
static PyMethodDef union_methods[] = {
    {"__mro_entries__", union_mro_entries, METH_O|METH_C_STACK_FRUGAL},
    {"__class_getitem__", union_class_getitem, METH_O|METH_CLASS|METH_C_STACK_FRUGAL, PyDoc_STR("See PEP 585")},
    {0}
};
