...
static PyType_Slot_Extra PyTclObject_Type_slots_ex[] = {
...
static PyType_Spec PyTclObject_Type_spec = {
    ...
    .slot_extras = PyTclObject_Type_slots_ex,
};
...
static PyType_Slot_Extra Tktt_Type_slots_ex[] = {
    {Py_tp_dealloc, Py_FNFLAGS_FRUGAL},
    {Py_tp_repr, Py_FNFLAGS_FRUGAL},
    {0, 0},
};
...
static PyType_Spec Tktt_Type_spec = {
    ...
    .slot_extras = Tktt_Type_slots_ex,
};
...
static PyType_Slot_Extra Tkapp_Type_slots_ex[] = {
    {Py_tp_dealloc, Py_FNFLAGS_FRUGAL},
    {0, 0},
};
...
static PyType_Spec Tkapp_Type_spec = {
    ...
    .slot_extras = Tkapp_Type_slots_ex,
};
