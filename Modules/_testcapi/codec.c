...
static PyMethodDef test_methods[] = {
    /* codecs registration */
    {"codec_register", codec_register, METH_O|METH_C_STACK_FRUGAL},
    {"codec_unregister", codec_unregister, METH_O|METH_C_STACK_FRUGAL},
    {"codec_known_encoding", codec_known_encoding, METH_VARARGS|METH_C_STACK_FRUGAL},
    /* encoding and decoding interface */
    {"codec_encode", codec_encode, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_decode", codec_decode, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_encoder", codec_encoder, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_decoder", codec_decoder, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_incremental_encoder", codec_incremental_encoder, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_incremental_decoder", codec_incremental_decoder, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_stream_reader", codec_stream_reader, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_stream_writer", codec_stream_writer, METH_VARARGS|METH_C_STACK_FRUGAL},
    /* error handling */
    {"codec_register_error", codec_register_error, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_lookup_error", codec_lookup_error, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"codec_strict_errors", codec_strict_errors, METH_O|METH_C_STACK_FRUGAL},
    {"codec_ignore_errors", codec_ignore_errors, METH_O|METH_C_STACK_FRUGAL},
    {"codec_replace_errors", codec_replace_errors, METH_O|METH_C_STACK_FRUGAL},
    {"codec_xmlcharrefreplace_errors", codec_xmlcharrefreplace_errors, METH_O|METH_C_STACK_FRUGAL},
    {"codec_backslashreplace_errors", codec_backslashreplace_errors, METH_O|METH_C_STACK_FRUGAL},
