...
static PyMethodDef test_methods[] = {
    {"PyDateTime_DATE_GET",         test_PyDateTime_DATE_GET,       METH_O|METH_C_STACK_FRUGAL},
    {"PyDateTime_DELTA_GET",        test_PyDateTime_DELTA_GET,      METH_O|METH_C_STACK_FRUGAL},
    {"PyDateTime_GET",              test_PyDateTime_GET,            METH_O|METH_C_STACK_FRUGAL},
    {"PyDateTime_TIME_GET",         test_PyDateTime_TIME_GET,       METH_O|METH_C_STACK_FRUGAL},
    {"datetime_check_date",         datetime_check_date,            METH_VARARGS|METH_C_STACK_FRUGAL},
    {"datetime_check_datetime",     datetime_check_datetime,        METH_VARARGS|METH_C_STACK_FRUGAL},
    {"datetime_check_delta",        datetime_check_delta,           METH_VARARGS|METH_C_STACK_FRUGAL},
    {"datetime_check_time",         datetime_check_time,            METH_VARARGS|METH_C_STACK_FRUGAL},
    {"datetime_check_tzinfo",       datetime_check_tzinfo,          METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_date_fromdate",           get_date_fromdate,              METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_date_fromtimestamp",      get_date_fromtimestamp,         METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_datetime_fromdateandtime", get_datetime_fromdateandtime,  METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_datetime_fromdateandtimeandfold", get_datetime_fromdateandtimeandfold, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_datetime_fromtimestamp",  get_datetime_fromtimestamp,     METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_delta_fromdsu",           get_delta_fromdsu,              METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_time_fromtime",           get_time_fromtime,              METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_time_fromtimeandfold",    get_time_fromtimeandfold,       METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_timezone_utc_capi",       get_timezone_utc_capi,          METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_timezones_offset_zero",   get_timezones_offset_zero,      METH_NOARGS|METH_C_STACK_FRUGAL},
    {"make_timezones_capi",         make_timezones_capi,            METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_datetime_capi",          test_datetime_capi,             METH_NOARGS|METH_C_STACK_FRUGAL},
    {NULL},
};
