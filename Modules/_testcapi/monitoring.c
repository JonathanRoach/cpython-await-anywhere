...
static PyMethodDef TestMethods[] = {
    {"fire_event_py_start", fire_event_py_start, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_py_resume", fire_event_py_resume, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_py_return", fire_event_py_return, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_c_return", fire_event_c_return, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_py_yield", fire_event_py_yield, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_call", fire_event_call, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_line", fire_event_line, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_jump", fire_event_jump, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_branch_left", fire_event_branch_left, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_branch_right", fire_event_branch_right, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_py_throw", fire_event_py_throw, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_raise", fire_event_raise, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_c_raise", fire_event_c_raise, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_reraise", fire_event_reraise, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_exception_handled", fire_event_exception_handled, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_py_unwind", fire_event_py_unwind, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"fire_event_stop_iteration", fire_event_stop_iteration, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"monitoring_enter_scope", enter_scope, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"monitoring_exit_scope", exit_scope, METH_VARARGS|METH_C_STACK_FRUGAL},
    {NULL},
};
