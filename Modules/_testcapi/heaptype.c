...
static PyMethodDef TestMethods[] = {
    {"pytype_fromspec_meta",    pytype_fromspec_meta,            METH_O|METH_C_STACK_FRUGAL},
    {"test_type_from_ephemeral_spec", test_type_from_ephemeral_spec, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"create_type_from_repeated_slots",
        create_type_from_repeated_slots, METH_O|METH_C_STACK_FRUGAL},
    {"test_from_spec_metatype_inheritance", test_from_spec_metatype_inheritance,
     METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_from_spec_invalid_metatype_inheritance",
     test_from_spec_invalid_metatype_inheritance,
     METH_NOARGS|METH_C_STACK_FRUGAL},
    {"make_immutable_type_with_base", make_immutable_type_with_base, METH_O|METH_C_STACK_FRUGAL},
    {"make_type_with_base", make_type_with_base, METH_O|METH_C_STACK_FRUGAL},
    {"pyobject_getitemdata", pyobject_getitemdata, METH_O|METH_C_STACK_FRUGAL},
    {"create_type_with_token", create_type_with_token, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_tp_token", get_tp_token, METH_O|METH_C_STACK_FRUGAL},
    {"pytype_getbasebytoken", pytype_getbasebytoken, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pytype_getmodulebydef", pytype_getmodulebydef, METH_O|METH_C_STACK_FRUGAL},
    {NULL},
};
