...
static PyMethodDef test_methods[] = {
    {"call_pyobject_print", call_pyobject_print, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pyobject_print_null", pyobject_print_null, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pyobject_print_noref_object", pyobject_print_noref_object, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pyobject_print_os_error", pyobject_print_os_error, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pyobject_clear_weakrefs_no_callbacks", pyobject_clear_weakrefs_no_callbacks, METH_O|METH_C_STACK_FRUGAL},
    {"pyobject_enable_deferred_refcount", pyobject_enable_deferred_refcount, METH_O|METH_C_STACK_FRUGAL},
    {"pyobject_is_unique_temporary", pyobject_is_unique_temporary, METH_O|METH_C_STACK_FRUGAL},
    {"test_py_try_inc_ref", test_py_try_inc_ref, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_xincref_doesnt_leak",test_xincref_doesnt_leak,        METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_incref_doesnt_leak", test_incref_doesnt_leak,         METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_xdecref_doesnt_leak",test_xdecref_doesnt_leak,        METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_decref_doesnt_leak", test_decref_doesnt_leak,         METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_incref_decref_API",  test_incref_decref_API,          METH_NOARGS|METH_C_STACK_FRUGAL},
#ifdef Py_REF_DEBUG
    {"negative_refcount", negative_refcount, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"decref_freed_object", decref_freed_object, METH_NOARGS|METH_C_STACK_FRUGAL},
#endif
    {"test_py_clear", test_py_clear, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_py_setref", test_py_setref, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_refcount_macros", test_refcount_macros, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_refcount_funcs", test_refcount_funcs, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_py_is_macros", test_py_is_macros, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_py_is_funcs", test_py_is_funcs, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"clear_managed_dict", clear_managed_dict, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"is_uniquely_referenced", is_uniquely_referenced, METH_O|METH_C_STACK_FRUGAL},
    {NULL},
};
