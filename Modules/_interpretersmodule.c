...
static PyMethodDef module_functions[] = {
    {"new_config",                _PyCFunction_CAST(interp_new_config),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, new_config_doc},

    {"create",                    _PyCFunction_CAST(interp_create),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, create_doc},
    {"destroy",                   _PyCFunction_CAST(interp_destroy),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, destroy_doc},
    {"list_all",                  _PyCFunction_CAST(interp_list_all),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, list_all_doc},
    {"get_current",               interp_get_current,
     METH_NOARGS|METH_C_STACK_FRUGAL, get_current_doc},
    {"get_main",                  interp_get_main,
     METH_NOARGS|METH_C_STACK_FRUGAL, get_main_doc},

    {"is_running",                _PyCFunction_CAST(interp_is_running),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, is_running_doc},
    {"get_config",                _PyCFunction_CAST(interp_get_config),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, get_config_doc},
    {"whence",                    _PyCFunction_CAST(interp_whence),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, whence_doc},
    {"exec",                      _PyCFunction_CAST(interp_exec),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, exec_doc},
    {"call",                      _PyCFunction_CAST(interp_call),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, call_doc},
    {"run_string",                _PyCFunction_CAST(interp_run_string),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, run_string_doc},
    {"run_func",                  _PyCFunction_CAST(interp_run_func),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, run_func_doc},

    {"set___main___attrs",        _PyCFunction_CAST(interp_set___main___attrs),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, set___main___attrs_doc},
    ...
    {"is_shareable",              _PyCFunction_CAST(object_is_shareable),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, is_shareable_doc},

    {"capture_exception",         _PyCFunction_CAST(capture_exception),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, capture_exception_doc},
