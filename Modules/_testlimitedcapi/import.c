...
static PyMethodDef test_methods[] = {
    {"PyImport_GetMagicNumber", pyimport_getmagicnumber, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"PyImport_GetMagicTag", pyimport_getmagictag, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"PyImport_GetModuleDict", pyimport_getmoduledict, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"PyImport_GetModule", pyimport_getmodule, METH_O|METH_C_STACK_FRUGAL},
    {"PyImport_AddModuleObject", pyimport_addmoduleobject, METH_O|METH_C_STACK_FRUGAL},
    {"PyImport_AddModule", pyimport_addmodule, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_AddModuleRef", pyimport_addmoduleref, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_Import", pyimport_import, METH_O|METH_C_STACK_FRUGAL},
    {"PyImport_ImportModule", pyimport_importmodule, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportModuleNoBlock", pyimport_importmodulenoblock, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportModuleEx", pyimport_importmoduleex, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportModuleLevel", pyimport_importmodulelevel, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportModuleLevelObject", pyimport_importmodulelevelobject, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportFrozenModule", pyimport_importfrozenmodule, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ImportFrozenModuleObject", pyimport_importfrozenmoduleobject, METH_O|METH_C_STACK_FRUGAL},
    {"PyImport_ExecCodeModule", pyimport_executecodemodule, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ExecCodeModuleEx", pyimport_executecodemoduleex, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ExecCodeModuleWithPathnames", pyimport_executecodemodulewithpathnames, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"PyImport_ExecCodeModuleObject", pyimport_executecodemoduleobject, METH_VARARGS|METH_C_STACK_FRUGAL},
    {NULL},
};
