...
static PyMethodDef test_methods[] = {
    ...
    {"pylong_check",                pylong_check,               METH_O|METH_C_STACK_FRUGAL},
    {"pylong_checkexact",           pylong_checkexact,          METH_O|METH_C_STACK_FRUGAL},
    {"pylong_fromdouble",           pylong_fromdouble,          METH_O|METH_C_STACK_FRUGAL},
    {"pylong_fromstring",           pylong_fromstring,          METH_VARARGS|METH_C_STACK_FRUGAL},
    {"pylong_fromvoidptr",          pylong_fromvoidptr,         METH_O|METH_C_STACK_FRUGAL},
    _TESTLIMITEDCAPI_PYLONG_ASINT_METHODDEF
    {"pylong_aslong",               pylong_aslong,              METH_O|METH_C_STACK_FRUGAL},
    {"pylong_aslongandoverflow",    pylong_aslongandoverflow,   METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asunsignedlong",       pylong_asunsignedlong,      METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asunsignedlongmask",   pylong_asunsignedlongmask,  METH_O|METH_C_STACK_FRUGAL},
    {"pylong_aslonglong",           pylong_aslonglong,          METH_O|METH_C_STACK_FRUGAL},
    {"pylong_aslonglongandoverflow", pylong_aslonglongandoverflow, METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asunsignedlonglong",   pylong_asunsignedlonglong,  METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asunsignedlonglongmask", pylong_asunsignedlonglongmask, METH_O|METH_C_STACK_FRUGAL},
    {"pylong_as_ssize_t",           pylong_as_ssize_t,          METH_O|METH_C_STACK_FRUGAL},
    {"pylong_as_size_t",            pylong_as_size_t,           METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asdouble",             pylong_asdouble,            METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asvoidptr",            pylong_asvoidptr,           METH_O|METH_C_STACK_FRUGAL},
    {"pylong_aspid",                pylong_aspid,               METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asint32",              pylong_asint32,             METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asuint32",             pylong_asuint32,            METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asint64",              pylong_asint64,             METH_O|METH_C_STACK_FRUGAL},
    {"pylong_asuint64",             pylong_asuint64,            METH_O|METH_C_STACK_FRUGAL},
    {NULL},
};
