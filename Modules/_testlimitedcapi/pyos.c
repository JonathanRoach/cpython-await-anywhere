...
static PyMethodDef test_methods[] = {
    {"test_PyOS_mystrnicmp", test_PyOS_mystrnicmp, METH_NOARGS|METH_C_STACK_FRUGAL, NULL},
    {"test_PyOS_mystricmp", test_PyOS_mystricmp, METH_NOARGS|METH_C_STACK_FRUGAL, NULL},
    {NULL},
};
