...
static PyMethodDef test_methods[] = {
    {"object_repr", object_repr, METH_O|METH_C_STACK_FRUGAL},
    {"object_ascii", object_ascii, METH_O|METH_C_STACK_FRUGAL},
    {"object_str", object_str, METH_O|METH_C_STACK_FRUGAL},
    {"object_bytes", object_bytes, METH_O|METH_C_STACK_FRUGAL},

    {"object_getattr", object_getattr, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_getattrstring", object_getattrstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_hasattr", object_hasattr, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_hasattrstring", object_hasattrstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_setattr", object_setattr, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_setattrstring", object_setattrstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_delattr", object_delattr, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_delattrstring", object_delattrstring, METH_VARARGS|METH_C_STACK_FRUGAL},

    {"number_check", number_check, METH_O|METH_C_STACK_FRUGAL},
    {"mapping_check", mapping_check, METH_O|METH_C_STACK_FRUGAL},
    {"mapping_size", mapping_size, METH_O|METH_C_STACK_FRUGAL},
    {"mapping_length", mapping_length, METH_O|METH_C_STACK_FRUGAL},
    {"object_getitem", object_getitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_getitemstring", mapping_getitemstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_haskey", mapping_haskey, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_haskeystring", mapping_haskeystring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_haskeywitherror", mapping_haskeywitherror, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_haskeystringwitherror", mapping_haskeystringwitherror, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_setitem", object_setitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_setitemstring", mapping_setitemstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"object_delitem", object_delitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_delitem", mapping_delitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_delitemstring", mapping_delitemstring, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"mapping_keys", mapping_keys, METH_O|METH_C_STACK_FRUGAL},
    {"mapping_values", mapping_values, METH_O|METH_C_STACK_FRUGAL},
    {"mapping_items", mapping_items, METH_O|METH_C_STACK_FRUGAL},

    {"sequence_check", sequence_check, METH_O|METH_C_STACK_FRUGAL},
    {"sequence_size", sequence_size, METH_O|METH_C_STACK_FRUGAL},
    {"sequence_length", sequence_length, METH_O|METH_C_STACK_FRUGAL},
    {"sequence_concat", sequence_concat, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_repeat", sequence_repeat, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_inplaceconcat", sequence_inplaceconcat, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_inplacerepeat", sequence_inplacerepeat, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_getitem", sequence_getitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_setitem", sequence_setitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_delitem", sequence_delitem, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_setslice", sequence_setslice, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_delslice", sequence_delslice, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_count", sequence_count, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_contains", sequence_contains, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_index", sequence_index, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"sequence_list", sequence_list, METH_O|METH_C_STACK_FRUGAL},
    {"sequence_tuple", sequence_tuple, METH_O|METH_C_STACK_FRUGAL},
    {"sequence_fast", sequence_fast, METH_VARARGS|METH_C_STACK_FRUGAL},
