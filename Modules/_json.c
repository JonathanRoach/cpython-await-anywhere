...
{
    _PY_ENSURE_COSTACK_HEADROOM_FOR_FN5_B(PyErr_NoMemory(), PyObject *, _parse_object_unicode, s, memo, pystr, idx, next_idx_ptr)
...
_parse_array_unicode(PyScannerObject *s, PyObject *memo, PyObject *pystr, Py_ssize_t idx, Py_ssize_t *next_idx_ptr) {
    _PY_ENSURE_COSTACK_HEADROOM_FOR_FN5_B(PyErr_NoMemory(), PyObject *, _parse_array_unicode, s, memo, pystr, idx, next_idx_ptr)
...
encoder_encode_float(PyEncoderObject *s, PyObject *obj)
{
    ...
    return PyType_Call_tp_repr(&PyFloat_Type, obj);
}
...
encoder_listencode_obj(PyEncoderObject *s, PyUnicodeWriter *writer,
                       ...
                       Py_ssize_t indent_level, PyObject *indent_cache)
{
    _PY_ENSURE_COSTACK_HEADROOM_FOR_FN5_B((PyErr_NoMemory(), -1), int, encoder_listencode_obj, s, writer, obj, indent_level, indent_cache)
    ...
    if (obj == Py_None) {
      ...
      return PyUnicodeWriter_WriteASCII(writer, "false", 5);
        ...
        PyObject *encoded = PyType_Call_tp_repr(&PyLong_Type, obj);
        if (encoded == NULL)
            return -1;
        return _steal_accumulate(writer, encoded);
    }
                         ...
                         PyObject *item_separator)
{
    ...
    if (PyUnicode_Check(key)) {
        ...
        keystr = PyType_Call_tp_repr(&PyLong_Type, key);
    }
    else if (s->skipkeys) {
        return 0;
    }
...
encoder_listencode_dict(PyEncoderObject *s, PyUnicodeWriter *writer,
                       ...
                       Py_ssize_t indent_level, PyObject *indent_cache)
{
    _PY_ENSURE_COSTACK_HEADROOM_FOR_FN5_B((PyErr_NoMemory(), -1), int, encoder_listencode_dict, s, writer, dct, indent_level, indent_cache)
...
encoder_listencode_list(PyEncoderObject *s, PyUnicodeWriter *writer,
                        ...
                        Py_ssize_t indent_level, PyObject *indent_cache)
{
    _PY_ENSURE_COSTACK_HEADROOM_FOR_FN5_B((PyErr_NoMemory(), -1), int, encoder_listencode_list, s, writer, seq, indent_level, indent_cache)
    PyObject *ident = NULL;
