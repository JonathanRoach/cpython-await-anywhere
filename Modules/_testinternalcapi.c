...
static PyMethodDef module_functions[] = {
    {"get_configs", get_configs, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"get_recursion_depth", get_recursion_depth, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"get_c_recursion_remaining", get_c_recursion_remaining, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_bswap", test_bswap, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_popcount", test_popcount, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_bit_length", test_bit_length, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_hashtable", test_hashtable, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"reset_path_config", test_reset_path_config, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_edit_cost", test_edit_cost, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"test_bytes_find", test_bytes_find, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"normalize_path", normalize_path, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"get_getpath_codeobject", get_getpath_codeobject, METH_NOARGS|METH_C_STACK_FRUGAL, NULL},
    {"EncodeLocaleEx", encode_locale_ex, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"DecodeLocaleEx", decode_locale_ex, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"set_eval_frame_default", set_eval_frame_default, METH_NOARGS|METH_C_STACK_FRUGAL, NULL},
    {"set_eval_frame_record", set_eval_frame_record, METH_O|METH_C_STACK_FRUGAL, NULL},
    ...
    {"get_interp_settings", get_interp_settings, METH_VARARGS|METH_C_STACK_FRUGAL, NULL},
    {"clear_extension", clear_extension, METH_VARARGS|METH_C_STACK_FRUGAL, NULL},
    {"write_perf_map_entry", write_perf_map_entry, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"perf_map_state_teardown", perf_map_state_teardown, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"iframe_getcode", iframe_getcode, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"iframe_getline", iframe_getline, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"iframe_getlasti", iframe_getlasti, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"code_returns_only_none", code_returns_only_none, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"get_co_framesize", get_co_framesize, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"get_co_localskinds", get_co_localskinds, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"get_code_var_counts", _PyCFunction_CAST(get_code_var_counts),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, NULL},
    {"verify_stateless_code", _PyCFunction_CAST(verify_stateless_code),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL, NULL},
#ifdef _Py_TIER2
    {"add_executor_dependency", add_executor_dependency, METH_VARARGS|METH_C_STACK_FRUGAL, NULL},
    {"invalidate_executors", invalidate_executors, METH_O|METH_C_STACK_FRUGAL, NULL},
#endif
    {"pending_threadfunc", _PyCFunction_CAST(pending_threadfunc),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL},
    {"pending_identify", pending_identify, METH_VARARGS|METH_C_STACK_FRUGAL, NULL},
    {"_PyTraceMalloc_GetTraceback", tracemalloc_get_traceback, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"test_tstate_capi", test_tstate_capi, METH_NOARGS|METH_C_STACK_FRUGAL, NULL},
    {"_PyUnicode_TransformDecimalAndSpaceToASCII", unicode_transformdecimalandspacetoascii, METH_O|METH_C_STACK_FRUGAL},
    {"check_pyobject_forbidden_bytes_is_freed",
                            check_pyobject_forbidden_bytes_is_freed, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"check_pyobject_freed_is_freed", check_pyobject_freed_is_freed, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"check_pyobject_null_is_freed",  check_pyobject_null_is_freed,  METH_NOARGS|METH_C_STACK_FRUGAL},
    {"check_pyobject_uninitialized_is_freed",
                              check_pyobject_uninitialized_is_freed, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"pymem_getallocatorsname", test_pymem_getallocatorsname, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"get_object_dict_values", get_object_dict_values, METH_O|METH_C_STACK_FRUGAL},
    {"hamt", new_hamt, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"dict_getitem_knownhash",  dict_getitem_knownhash,          METH_VARARGS|METH_C_STACK_FRUGAL},
    ...
    {"run_in_subinterp_with_config",
     ...
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL},
    {"normalize_interp_id", normalize_interp_id, METH_O|METH_C_STACK_FRUGAL},
    {"next_interpreter_id", next_interpreter_id, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"unused_interpreter_id", unused_interpreter_id, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"interpreter_exists", interpreter_exists, METH_O|METH_C_STACK_FRUGAL},
    {"get_interpreter_refcount", get_interpreter_refcount, METH_O|METH_C_STACK_FRUGAL},
    {"link_interpreter_refcount", link_interpreter_refcount,     METH_O|METH_C_STACK_FRUGAL},
    {"unlink_interpreter_refcount", unlink_interpreter_refcount, METH_O|METH_C_STACK_FRUGAL},
    {"interpreter_refcount_linked", interpreter_refcount_linked, METH_O|METH_C_STACK_FRUGAL},
    {"compile_perf_trampoline_entry", compile_perf_trampoline_entry, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"perf_trampoline_set_persist_after_fork", perf_trampoline_set_persist_after_fork, METH_VARARGS|METH_C_STACK_FRUGAL},
    {"get_crossinterp_data",    _PyCFunction_CAST(get_crossinterp_data),
     METH_VARARGS | METH_KEYWORDS|METH_C_STACK_FRUGAL},
    {"restore_crossinterp_data", restore_crossinterp_data,       METH_VARARGS|METH_C_STACK_FRUGAL},
    _TESTINTERNALCAPI_TEST_LONG_NUMBITS_METHODDEF
    {"get_rare_event_counters", get_rare_event_counters, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"reset_rare_event_counters", reset_rare_event_counters, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"has_inline_values", has_inline_values, METH_O|METH_C_STACK_FRUGAL},
    {"has_split_table", has_split_table, METH_O|METH_C_STACK_FRUGAL},
    {"type_assign_specific_version_unsafe", type_assign_specific_version_unsafe, METH_VARARGS|METH_C_STACK_FRUGAL,
     PyDoc_STR("forcefully assign type->tp_version_tag")},

#ifdef Py_GIL_DISABLED
    {"py_thread_id", get_py_thread_id, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"get_tlbc", get_tlbc, METH_O|METH_C_STACK_FRUGAL, NULL},
    {"get_tlbc_id", get_tlbc_id, METH_O|METH_C_STACK_FRUGAL, NULL},
#endif
#ifdef _Py_TIER2
    {"uop_symbols_test", _Py_uop_symbols_test, METH_NOARGS|METH_C_STACK_FRUGAL},
#endif
    GH_119213_GETARGS_METHODDEF
    {"get_static_builtin_types", get_static_builtin_types, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"identify_type_slot_wrappers", identify_type_slot_wrappers, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"has_deferred_refcount", has_deferred_refcount, METH_O|METH_C_STACK_FRUGAL},
    {"get_tracked_heap_size", get_tracked_heap_size, METH_NOARGS|METH_C_STACK_FRUGAL},
    {"is_static_immortal", is_static_immortal, METH_O|METH_C_STACK_FRUGAL},
    {"incref_decref_delayed", incref_decref_delayed, METH_O|METH_C_STACK_FRUGAL},
