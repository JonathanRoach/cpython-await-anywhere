...
EXPORT_FUNC(_Py_Coroutine_Delete)
EXPORT_FUNC(_Py_Coroutine_IsRunning)
EXPORT_FUNC(_Py_Coroutine_IsComplete)
EXPORT_FUNC(_Py_Coroutine_Continue)
EXPORT_FUNC(_Py_Coroutine_Yield)
EXPORT_FUNC(_Py_Coroutine_GetValue)
EXPORT_FUNC(_Py_Coroutine_GetStackHeadroom)
EXPORT_FUNC(_Py_Coroutine_GetActive)
EXPORT_FUNC(_PyDatastack_Clear)
